...
describe('normalizeResponseData', () => {
  it('should return the normalized response for valid input data', () => {
    ...
    const expectedOutput = [
      { file: 'file1.csv', lines: [{ text: 'text1', number: '1', hex: 'hex1' }, { text: 'text2', number: '2', hex: 'hex2' }] },
      { file: 'file2.csv', lines: [{ text: 'text3', number: '3', hex: 'hex3' },{ text: 'text4', number: '4', hex: 'hex4' }] },
