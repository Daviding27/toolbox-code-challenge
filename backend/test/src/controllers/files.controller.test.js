...
import { FileRepository, filterValidLines, getDataListCtrl, getDataNormalizedCtrl, normalizeResponseData } from '../../../src/files/index.js';
...
describe('getDataNormalizedCtrl', () => {
    it('should return normalized response of all files', async () => {
        ...
        const req = { query: { fileName: undefined } };
          ...
          const fakeNormalizedData = [{ file: 'test1A.csv', lines: [{ text: 'VMVMXutdEHH', number: '674504994', hex: 'c88a1bbc8276fdbe125a7b933d6becd3' }] }];
